package de.uhd.ifi.se.accompleteness.extractor.openie.util;
...
public class ActionUtils {
     ...
     * @see de.uhd.ifi.se.acgen.generator.gherkin.GherkinGenerator#extractActions
     */
    public static List<Topic> extractActionFromConditionalStarterWord(CoreSentence sentence, String userStoryString, IndexedWord conditionalStarterWord, int indexSoThat) {
        ...
        if (conditionalStarterWord.index() < indexSoThat) {
            ...
            topics.add(new Topic(actionString));
        } else {
            ...
            topics.add(new Topic(actionString));
            topics.addAll(extractResultInformationInReason(sentence, userStoryString, endIndex));
        }
        return topics;
    }
     ...
     * @see ActionUtils#extractActionFromConditionalStarterWord
     */
    private static List<Topic> extractResultInformationInReason(CoreSentence sentence, String userStoryString, int endIndexOfAction) {
        List<Topic> topics = new ArrayList<Topic>();
        int wordsInSentenceCount = sentence.dependencyParse().getSubgraphVertices(sentence.dependencyParse().getFirstRoot()).size();
     ...
     * @see de.uhd.ifi.se.acgen.generator.gherkin.GherkinGenerator#extractActions
     */
    public static List<Topic> extractActionFromInteraction(CoreSentence sentence, String userStoryString) {
        List<Topic> topics = new ArrayList<Topic>();
        ...
        if (endPosition != -1) {
            ...
            topics.add(new Topic("the user clicks " + acceptanceCriterionString));
        }
        return topics;
    }
